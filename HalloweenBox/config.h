...
// Default shape includes the caruncle, creating distinct left/right eyes. // Option to define symmetrical eyelid
...
// Code updated for default two eyes
...
#if defined(_ADAFRUIT_ST7735H_) // Defined in Adafruit_ST7735.h
